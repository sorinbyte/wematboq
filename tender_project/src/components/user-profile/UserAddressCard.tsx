        ...
        <div className="flex flex-col gap-6 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            <div className="grid grid-cols-1 gap-4 lg:grid-cols-2 lg:gap-7 2xl:gap-x-32">
              <div>
                <p className="mb-2 text-xs text-gray-500 dark:text-gray-400">Nume companie</p>
              ...
              <div>
                <p className="mb-2 text-xs text-gray-500 dark:text-gray-400">ID Unic</p>
                <p className="text-sm font-medium text-gray-800 dark:text-white/90">
                  {user.uniqueId}
                </p>
              </div>
        ...
        <div className="relative w-full p-4 overflow-y-auto bg-white rounded-3xl dark:bg-gray-900 lg:p-11">
          <div className="px-2 pr-14">
            <h4 className="mb-2 text-2xl font-semibold text-gray-800 dark:text-white/90">
              Editează adresa companiei
            </h4>
            <p className="mb-6 text-sm text-gray-500 dark:text-gray-400">
              Actualizează datele companiei tale.
            </p>
          </div>
          <form className="flex flex-col">
            <div className="px-2">
              <div className="grid grid-cols-1 gap-x-6 gap-y-5 lg:grid-cols-2">
                ...
                <div>
                  <Label>ID Unic</Label>
                  <Input type="text" defaultValue={user.uniqueId} />
                </div>
              </div>
            </div>
